...
const MOCK_NOTIFS = [
  {
    ...
    type: "match",
    title: "It's a Match! 🎉",
    body: "You and Alicia Rivera both liked each other. Say hello!",
    icon: "♥",
    time: "Just now",
    read: false,
    actionUrl: "/connect",
  },
  {
    ...
    type: "message",
    title: "New Message",
    body: "Devon W. sent you a message: 'Brother, faith is what kept me...'",
    icon: "✉",
    time: "5m ago",
    read: false,
    actionUrl: "/messages",
  },
  {
    ...
    type: "job",
    title: "Job Alert",
    body: "3 new felony-friendly jobs were posted in Texas that match your profile.",
    icon: "💼",
    time: "1h ago",
    read: false,
    actionUrl: "/jobs",
  },
  {
    ...
    type: "system",
    title: "Profile Tip",
    body: "Add your interests to get 4x more profile views and better matches.",
    icon: "⭐",
    time: "3h ago",
    read: true,
    actionUrl: "/profile",
...
const EMAIL_TEMPLATES = [
  {
    ...
    subject: "Welcome to New Horizon ✦",
    status: "Active",
  },
  {
    name: "Match Notification",
    trigger: "On mutual like",
  ...
  },
  {
    ...
    subject: "{{job_count}} new jobs match your profile",
    status: "Active",
  },
  {
    name: "Weekly Resource Update",
    trigger: "Every Monday",
    subject: "New resources for returning citizens in {{state}}",
    status: "Draft",
  },
  {
    name: "Account Verification",
    trigger: "On signup",
    subject: "Verify your New Horizon email",
    status: "Active",
  },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        gap: 14,
        padding: "14px 20px",
        background: n.read ? "white" : T.gold + "07",
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          <span style={{ fontWeight: 600, fontSize: 14, color: T.charcoal }}>
            {n.title}
          </span>
          <span
            style={{
        ...
        <p style={{ fontSize: 13, color: T.slate, lineHeight: 1.5, margin: 0 }}>
          {n.body}
        </p>
              ...
              >
                ...
                >
                  <span style={{ fontWeight: 600, fontSize: 15 }}>
                    Notifications{" "}
                    {unread > 0 && (
                      <span style={{ color: T.gold }}>({unread})</span>
                    )}
                  </span>
                  <button
                    onClick={markAll}
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: "32px 24px" }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: T.slate }}>
            Real-time alerts, preferences, and email templates managed in one
            place.
          </p>
        </div>
        ...
        >
          <div style={{ fontSize: 13, color: T.slate }}>
            {BACKEND_READY
              ? `Live backend: ${status}`
              : "Live backend disabled until .env is filled in."}
          </div>
          {profile?.email && (
            <div style={{ fontSize: 13, fontWeight: 500 }}>{profile.email}</div>
          )}
        </div>
          ...
          >
            <div>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      padding: "6px 16px",
                      borderRadius: 20,
                      background: filter === v ? T.gold : "white",
                      color: filter === v ? "white" : T.slate,
                      border: `1px solid ${filter === v ? T.gold : T.mist}`,
                      fontSize: 13,
              ...
              >
                {filtered.length === 0 ? (
                  <div
                    style={{ padding: 48, textAlign: "center", color: T.slate }}
                  >
                  ...
                  filtered.map((n, i) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onMouseLeave={(e) => (e.target.style.color = T.mist)}
                      >
                        ×
                      </button>
                    </div>
            ...
            <div>
              ...
              >
                ...
                {[
                  ...
                  [
                    "Matches",
                    notifs.filter((n) => n.type === "match").length,
                    T.rose,
                  ],
                  [
                    "Messages",
                    notifs.filter((n) => n.type === "message").length,
                    T.info,
                  ],
                  [
                    "Jobs",
                    notifs.filter((n) => n.type === "job").length,
                    T.success,
                  ],
                ].map(([l, v, c]) => (
                  <div
              ...
              >
                ...
                >
                  <div
                    style={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      background: BACKEND_READY && profile ? T.success : T.warn,
                ...
                <div
                  style={{ fontSize: 12, color: "#7A7A8A", lineHeight: 1.6 }}
                >
                  {BACKEND_READY
                    ? "This page listens for live notification inserts through Supabase real-time subscriptions."
                    : "Fill the project .env file with your Supabase values to enable live subscriptions."}
                </div>
              </div>
            </div>
          </div>
        ...
        {tab === "prefs" && (
          ...
          >
            {[
              ...
              },
              {
                ...
                items: [
                  [
                    "Matches & Likes",
                    "When someone likes or matches with you",
                    "matches",
                  ],
                  [
                    "New Messages",
                ...
                {section.items.map(([label, desc, key]) => (
                  ...
                  >
                    <div>
                      ...
                      <div
                        style={{ fontSize: 12, color: T.slate, marginTop: 2 }}
                      >
                        {desc}
                      </div>
                    </div>
                    <div
                      ...
                      style={{
                        ...
                        height: 24,
                        borderRadius: 12,
                        background: prefs[key] ? T.gold : T.mist,
                        position: "relative",
                        cursor: "pointer",
            ...
            >
              ...
              <p style={{ color: T.slate, fontSize: 13, marginBottom: 16 }}>
                Push and email preferences save to your profile when the backend
                is configured.
              </p>
            ...
            {EMAIL_TEMPLATES.map((t, i) => (
              ...
              >
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: 10,
                        background:
                          t.status === "Active" ? T.successL : T.warnL,
                        color: t.status === "Active" ? T.success : T.warn,
                      }}
                    >
                      {t.status}
                    </span>
                  ...
                  <div
                    style={{ fontSize: 12, color: T.slate, marginBottom: 2 }}
                  >
                    Trigger: {t.trigger}
                  </div>
            ...
            >
              ...
              >
                {[
                  ...
                  ["From Address", "hello@newhorizon.app"],
                  ["Reply-To", "support@newhorizon.app"],
                  ["Daily Limit", "50,000 / day (free tier)"],
                ].map(([l, v]) => (
                  <div key={l}>
                    <div
                      style={{
